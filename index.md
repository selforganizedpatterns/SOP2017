...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <section id="intro" class="intro">
		<div class="slogan">
			<h2><span style="color:#EC1414; text-shadow: -3px 1px 1px #000;">SOP 2017</span></h2>
			<h2><span style="color:#EC1414; text-shadow: -3px 1px 1px #000;">Control of Self-organized Patterns </br>on Complex Networks</span></h2>
            <h2><span style="color:#f25b5b; text-shadow: -3px 1px 1px #000;">21 September 2016 </span></h2>
            <h2><span style="text-shadow: -3px 1px 1px #000;"><a href="http://www.ccs2016.org">A satellite workshop of the</br>PhysCon2017</a></span></h2>
		</div>
